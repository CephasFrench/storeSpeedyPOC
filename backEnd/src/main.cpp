...
const int COMPUTE_PATH_MAX_RETRIES = 3;
const int COMPUTE_PATH_TIMEOUT_DURATION = 5000;
...
const int UPDATE_GROCERY_LIST_MAX_RETRIES = 3;
const int UPDATE_GROCERY_LIST_TIMEOUT_DURATION = 5000;
const int CHECK_ITEM_MAX_RETRIES = 3;
const int CHECK_ITEM_TIMEOUT_DURATION = 5000;
